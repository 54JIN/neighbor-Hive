public class buyerData {
    ...
    */
    ...
    public boolean removeBuyer(String firstName, String lastName, int zip){
        buyerData cursor=head;
        buyerData next=null;
        if (cursor != null && cursor.firstName.equals(firstName) && cursor.lastName.equals(lastName) && cursor.zip==zip){
            head = cursor.previous;
            return true;
        }
        while(cursor != null && !cursor.firstName.equals(firstName) && !cursor.lastName.equals(lastName) && cursor.zip !=zip){
            next=cursor;
            cursor=cursor.previous;
